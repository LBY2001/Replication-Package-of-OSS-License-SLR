...
# 前滚
# folder_path = r"C:\Users\小不点\Desktop\回滚\第二轮回滚\爬虫"  # 替换为你的文件夹路径
# output_file = r"C:\Users\小不点\Desktop\回滚\第二轮回滚\爬虫\merged.xlsx"  # 输出文件名

# 后滚
# folder_path = r"C:\Users\小不点\Desktop\回滚\参考文献gpt"  # 替换为你的文件夹路径
# output_file = r"C:\Users\小不点\Desktop\回滚\参考文献gpt\merged.xlsx"  # 输出文件名

folder_path = r"."  # 替换为你的文件夹路径
output_file = r".\Merged.xlsx"  # 输出文件名
